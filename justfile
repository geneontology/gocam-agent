...
gh-add-topics:
  gh repo edit --add-topic "gocam-agent,monarchinitiative,linkml"
...
gh-invite-the-dragon:
  gh api repos/geneontology/gocam-agent/collaborators/dragon-ai-agent -X PUT -f permission=push
