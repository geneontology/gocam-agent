# Contributing to gocam-agent

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
gocam-agent. These guidelines are not strict rules.
...
The gocam-agent team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the gocam-agent technical leads
...
[issues]: https://github.com/geneontology/gocam-agent/issues/
[pulls]: https://github.com/geneontology/gocam-agent/pulls/
