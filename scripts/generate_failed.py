...
failed_processes = [
    'ampar-synaptic-insertion', 'ampar-secretory-trafficking',
    'ampar-synthesis-assembly', 'ampar-postendocytic-sorting'
]
...
# Run with max_workers=2 to prevent CPU/memory saturation on the agent runner
with concurrent.futures.ThreadPoolExecutor(max_workers=2) as executor:
    executor.map(generate_process_def, failed_processes)
